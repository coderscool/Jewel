...
namespace JewelPainter.Gameplay.Board
{
    ...
    public class JewelFlyEffect : MonoBehaviour
    {
        ...
        [Tooltip("Độ vồng của đường bay. 0 là bay thẳng, trông máy móc; 2-3 cho vòng cung tự nhiên.")]
        ...
        private bool TryStartFlight(Vector2Int cell, int paletteIndex)
        {
            ...
            var sequence = DOTween.Sequence()
                .Append(flyer.transform.DOJump(target, _jumpPower, 1, _duration).SetEase(Ease.InOutQuad))
